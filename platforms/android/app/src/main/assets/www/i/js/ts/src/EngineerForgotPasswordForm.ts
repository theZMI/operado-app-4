class EngineerForgotPasswordForm {
    API: Api;
    ...
    private initFormStep1(): void {
        let form = $('#i-engineer-forgot-password-form_step-1');
        let self = this;
    ...
    private initFormStep2(): void {
        let self = this;
        let form = $('#i-engineer-forgot-password-form_step-2');
