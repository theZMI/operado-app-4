...
(function () {
    ...
    EkkoLightbox.prototype = {
        ...
        showLoading: function () {
            this.lightbox_body.html('<div class="modal-loading text-center" style="padding: 50px 0;"><img src="/i/image/load.gif"></div>');
            return this;
        },
        showYoutubeVideo: function (id) {
            var aspectRatio, height, width;
            aspectRatio = 697 / 315;
            width = this.$element.data('width') || 697;
            width = this.checkDimensions(width);
            height = width / aspectRatio;
            this.resize(width);

            // >>> ZMI add begin
            this.modal_dialog.addClass('modal-dialog-youtube');
            // <<< ZMI end
